...
\section{GraphQL}
GraphQL bylo vytvořeno společností Facebook v roce 2012. Hlavním důvodem jeho vzniku byla narůstající potřeba API pro získávání dat, které bude dostatečně silné a zároveň bude jednoduché na používání. V roce 2015 pak bylo GraphQL zpřístupněno jako opensource. Od této doby vznikla spousta implementací v různých jazycích jako je Javascript, Java, Python a mnoha dalších.

\subsection*{Graphql dotaz}
%img: https://www.apollographql.com/blog/static/5d820420290da80546e26d7c966b1d74/Untitled-1.png%
GraphQL dotaz je řetězec, který je poslán na server, vyhodnocen a jeho výsledek je zaslán ve formátu JSON zpátky klientovi. Dle obrázku %todo %
si můžeme všimnout, že struktura dotazu je velmi podobná struktuře odpovědi vrácené serverem.Existují dva druhý dotazů - query a mutace.
