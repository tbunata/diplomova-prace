...
export class ProductResolver {
  ...
  async allProducts(@Arg("productFilterData", { nullable: true }) productFilterData: ProductFilterInput) {
  ...
  async addProduct(@Arg("newProductData") newProductData: NewProductInput) {
  ...
  quantityUpdate(@Root() product: Product, @Args() args: QuantityUpdateArgs): Product {
    return product;
  }
}
